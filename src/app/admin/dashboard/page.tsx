...
export default function AdminDashboard() {
 ...
 case 'revoke': return <Shield className="w-4 h-4 text-semantic-success-700" />
 case 'alert': return <AlertTriangle className="w-4 h-4 text-crimson-paper" />
 ...
 <CardContent className="p-6">
 <div className="flex items-center gap-3">
 <div className="w-12 h-12 bg-semantic-success-700/10 rounded-lg flex items-center justify-center">
 <Activity className="w-6 h-6 text-semantic-success-700" />
 </div>
 <div>
 <p className="text-sm text-ink">Active Users</p>
 <p className="text-2xl font-bold text-semantic-success-700">{stats.activeUsers.toLocaleString()}</p>
 </div>
 </div>
 </CardContent>
 </Card>
 ...
 <CardContent className="p-6">
 <div className="flex items-center gap-3">
 <div className="w-12 h-12 bg-ink-blue/10 rounded-lg flex items-center justify-center">
 <BarChart3 className="w-6 h-6 text-ink-blue" />
 </div>
 <div>
 <p className="text-sm text-ink">Total Scans</p>
 <p className="text-2xl font-bold text-ink-blue">{stats.totalScans.toLocaleString()}</p>
 </div>
 </div>
 </CardContent>
 </Card>
 ...
 <CardContent className="p-6">
 <div className="flex items-center gap-3">
 <div className="w-12 h-12 bg-semantic-warning-700/10 rounded-lg flex items-center justify-center">
 <Shield className="w-6 h-6 text-semantic-warning-700" />
 </div>
 <div>
 <p className="text-sm text-ink">Revocations</p>
 <p className="text-2xl font-bold text-semantic-warning-700">{stats.totalRevocations.toLocaleString()}</p>
 </div>
 </div>
 </CardContent>
 </Card>
 ...
 <CheckCircle className="w-5 h-5 text-semantic-success-700" />
 System Health
 </CardTitle>
 </CardHeader>
 <CardContent>
