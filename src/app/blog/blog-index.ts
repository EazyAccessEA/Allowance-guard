...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: 'Every wallet decodes the transaction you are about to sign a little differently. Some show you the token, the spender, the amount, the deadline; some show you a hash and wish you luck. A practical comparison of the six most-used wallets on the specific question of whether you can read what you are signing.',
    publishedAt: '2026-04-19',
    readTime: '15 min read',
    category: 'Education',
    featured: false,
    image: '/images/blog/the-six-wallets-of-2026.webp',
  },
  {
    ...
    excerpt: 'A smart contract you have never interacted with is asking for an approval. You have roughly ninety seconds before the moment passes. Four lenses — bytecode, source, deployment history, and on-chain behaviour — give you enough signal to decide without needing to be a Solidity engineer.',
    publishedAt: '2026-04-19',
    readTime: '13 min read',
    category: 'Security',
    featured: false,
    image: '/images/blog/four-lenses-on-an-unknown-contract.webp',
  },
  {
    ...
    excerpt: 'A classic ERC-20 approval is revoked by writing zero on-chain. A Permit2 approval lives in a different place, expires on a different clock, and sometimes never touched the chain at all. A short walk-through of what Permit2 revocation actually looks like and when you still have to do it.',
    publishedAt: '2026-04-19',
    readTime: '8 min read',
    category: 'Tutorial',
    featured: false,
    image: '/images/blog/how-to-revoke-a-permit2-approval.webp',
  },
  {
