...
const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: 'True digital sovereignty requires a shift from digital convenience to physical security. Hardware wallets and multisigs create layers of defense that are nearly impossible for remote attackers to penetrate.',
  ...
  },
  {
    ...
    excerpt: 'Managing token allowances is like locking doors and windows. But what if the building itself has a cracked foundation? Smart contract risk goes beyond permissions—it\'s about the code you trust.',
    publishedAt: '2024-12-19',
  ...
  },
  {
    ...
    excerpt: 'We practice fire drills not because we expect a fire today, but so our response is automatic when it matters most. The most effective defense is not heroic effort—it\'s a quiet, consistent routine.',
    publishedAt: '2024-12-19',
    readTime: '8 min read',
    category: 'Security',
    featured: false,
  ...
  },
  {
    ...
    excerpt: 'Commercial pilots spend hundreds of hours in flight simulators, practicing their response to engine failures. Why should we treat our digital wealth with any less seriousness?',
    publishedAt: '2024-12-19',
    readTime: '10 min read',
    category: 'Security',
    featured: false,
  ...
  },
  {
    ...
    excerpt: 'When you give a house key to a contractor, you don\'t expect them to keep it forever. Yet in Web3, we routinely give smart contracts permanent, unlimited access. The solution is smarter automation: programmable safety.',
    publishedAt: '2024-12-19',
    readTime: '9 min read',
    category: 'Innovation',
    featured: false,
  ...
  },
  {
    ...
    excerpt: 'Every DeFi experience begins with a click: "Connect Wallet." Behind that click sits a world of permissions, smart contracts, and potential traps. Knowing how to recognize red flags can prevent catastrophic losses.',
    publishedAt: '2024-12-19',
    readTime: '7 min read',
    category: 'Security',
    featured: false,
  ...
  },
  {
    ...
    excerpt: 'Web3 gives you total custody of your assets—but it also makes you your own security officer. The good news is that auditing your wallet is easier than you think.',
    publishedAt: '2024-12-19',
    readTime: '6 min read',
    category: 'Security',
    featured: false,
  ...
  },
  {
    ...
    excerpt: 'Every time you connect a wallet to a DeFi app, you\'re asked to approve something. Most people click "Approve" without thinking. That click gives the app a token allowance—a standing permission to move your assets.',
  ...
  },
  {
    ...
    excerpt: 'Web3 is a frontier town rapidly growing into a global city. For too long, we have treated security as a purely personal problem. But to build a truly resilient ecosystem, we must become security advocates.',
    publishedAt: '2024-12-19',
    readTime: '12 min read',
    category: 'Community',
    featured: false,
          ...
          <Container>
            <div className="max-w-6xl mx-auto">
              ...
              <article className="group">
                <div className="relative rounded-2xl sm:rounded-3xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 sm:hover:-translate-y-2">
                  {/* Background Image */}
                  {featuredPost.image && (
