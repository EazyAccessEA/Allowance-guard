              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-300 hover:-translate-y-1 card-hover">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-stone leading-relaxed">
                      Your voice in the community is powerful social capital that helps spread awareness of Allowance Guard&apos;s mission. Share your positive experiences on X, Reddit, and other platforms where Web3 users gather. Your advocacy helps other users discover the tools they need to protect their assets and contributes to building a more security-conscious ecosystem.
                    </p>
                  </div>
                </div>
              </div>
