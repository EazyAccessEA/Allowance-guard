    ...
    <div className="min-h-screen bg-secondary-900 text-white">
      ...
      <Section className="relative py-20 sm:py-28 overflow-hidden bg-secondary-900">
        ...
        <Container className="relative text-left max-w-4xl z-20">
          ...
          <H1 className="mb-6 text-white">Fund the mission. Build the public layer.</H1>
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white/[0.05] rounded-2xl p-8 shadow-sm border border-white/10 hover:shadow-md transition-all duration-300 hover:-translate-y-1 card-hover">
        ...
        <Container>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white/[0.05] rounded-2xl shadow-sm border border-white/10 overflow-hidden">
                <button
                  onClick={() => toggleSection('development')}
                  className="w-full p-8 text-left hover:bg-white/[0.03] transition-colors duration-200 flex items-center justify-between micro-bounce"
                >
