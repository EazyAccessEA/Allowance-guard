...
export default function DocsContentSecondary({ section }: Props) {
 ...
 <div>
 <h2 id="alerts-notifications" className="text-2xl font-semibold text-white mb-4">Alerts & Notifications</h2>
 ...
 return (
 <div key={index} className="border border-white/10 rounded-lg p-6 bg-white/[0.05]">
 ...
 <div>
 <h4 className="text-lg font-semibold text-white mb-2">{alert.type}</h4>
 <p className="text-base text-slate-300 mb-4">{alert.description}</p>
 </div>
 </div>
 ...
 <div className="space-y-8">
 <div>
 <h2 id="autonomous-monitoring" className="text-2xl font-semibold text-white mb-4">Autonomous Monitoring</h2>
 <p className="text-base text-slate-300 mb-6">
 ...
 <div className="p-6 bg-white/[0.05] border border-white/10 rounded-lg">
 <div className="flex items-start gap-4 mb-4">
 <div className="w-12 h-12 bg-amber-500/10 ring-1 ring-amber-500/20 rounded-xl flex items-center justify-center flex-shrink-0">
 <Zap className="w-6 h-6 text-amber-400" />
 </div>
 <div>
 <h3 id="how-it-works" className="text-xl font-semibold text-white mb-3">How It Works</h3>
 </div>
 </div>
 <ol className="list-decimal list-inside space-y-2 text-base text-slate-300 ml-16">
 ...
 <div>
 <h3 id="drift-detection" className="text-xl font-semibold text-white mb-3">Drift Detection</h3>
 </div>
 </div>
 <p className="text-sm text-slate-300 mb-3">The system detects the following types of changes:</p>
 ...
 <div>
 <h3 id="configuration" className="text-xl font-semibold text-white mb-3">Configuration</h3>
 </div>
 </div>
 <p className="text-base text-slate-300 mb-4 ml-16">You can configure monitoring settings in the sidebar:</p>
 <ul className="space-y-2 text-base text-slate-300 ml-16">
 ...
 <div className="space-y-8">
 <div>
 <h2 id="teams-collaboration" className="text-2xl font-semibold text-white mb-4">Teams & Collaboration</h2>
 <p className="text-base text-slate-300 mb-6">
 ...
 <h3 className="text-xl font-semibold text-white mb-3">Team Roles</h3>
 ...
 <p className="text-base text-slate-300">Full control over the team, including adding/removing members, managing wallets, and inviting collaborators.</p>
 </div>
 </div>
 </div>
 <div className="p-6 bg-white/[0.05] border border-white/10 rounded-lg">
 ...
 <p className="text-base text-slate-300">Can manage team members, add wallets, and invite users. Cannot remove the owner.</p>
 </div>
 </div>
 </div>
 <div className="p-6 bg-white/[0.05] border border-white/10 rounded-lg">
 ...
 <div>
 <h4 className="text-lg font-semibold text-white mb-2">Editor</h4>
 <p className="text-base text-slate-300">Can add wallets to the team and invite viewers. Can revoke approvals and manage monitoring settings.</p>
 </div>
 </div>
 </div>
 <div className="p-6 bg-white/[0.05] border border-white/10 rounded-lg">
 ...
 <div>
 <h4 className="text-lg font-semibold text-white mb-2">Viewer</h4>
 <p className="text-base text-slate-300">Read-only access. Can view approvals and scan results but cannot revoke approvals or modify settings.</p>
 </div>
 </div>
 </div>
 </div>

 <h3 className="text-xl font-semibold text-white mb-3">Getting Started with Teams</h3>
 <ol className="list-decimal list-inside space-y-2 text-base text-slate-300 mb-6">
 ...
 <h3 className="text-xl font-semibold text-white mb-3">Team Features</h3>
 ...
 <div>
 <h4 className="text-lg font-semibold text-white mb-2">Shared Wallets</h4>
 <p className="text-base text-slate-300">Add multiple wallet addresses to a team for centralized monitoring</p>
 </div>
 </div>
 </div>
 <div className="p-6 bg-white/[0.05] border border-white/10 rounded-lg">
 ...
 <div>
 <h4 className="text-lg font-semibold text-white mb-2">Email Invites</h4>
 <p className="text-base text-slate-300">Invite team members via secure email links with role-based access</p>
 </div>
 </div>
 </div>
 <div className="p-6 bg-white/[0.05] border border-white/10 rounded-lg">
 ...
 <p className="text-base text-slate-300">Control permissions with owner, admin, editor, and viewer roles</p>
 </div>
 </div>
 </div>
 <div className="p-6 bg-white/[0.05] border border-white/10 rounded-lg">
 ...
 <div>
 <h4 className="text-lg font-semibold text-white mb-2">Team Monitoring</h4>
 <p className="text-base text-slate-300">Set up autonomous monitoring for team-managed wallets</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <div className="space-y-8">
 <div>
 <h2 className="text-2xl font-semibold text-white mb-4">How to Revoke Approvals</h2>
 <p className="text-base text-slate-300 mb-6">
 ...
 <div>
 <h4 className="text-lg font-semibold text-white mb-2">Using AllowanceGuard</h4>
 </div>
 </div>
 <ol className="list-decimal list-inside space-y-2 text-base text-slate-300 ml-16">
 ...
 <div className="space-y-8">
 <div>
 <h2 className="text-2xl font-semibold text-white mb-4">Settings & Configuration</h2>
 <p className="text-base text-slate-300 mb-6">
 ...
 <div className="space-y-6">
 {/* Email Alerts */}
 <div className="border border-white/10 rounded-md p-6 bg-white/[0.03]">
 ...
 <h3 className="text-lg font-semibold text-white">Risk Policy Configuration</h3>
 </div>
 <p className="text-sm text-slate-300 mb-4">
 ...
 <h3 className="text-lg font-semibold text-white">Public Share Links</h3>
 </div>
 <p className="text-sm text-slate-300 mb-4">
 ...
 <code className="font-mono text-white">{endpoint.endpoint}</code>
 <span className="text-slate-300">{endpoint.description}</span>
 </div>
 ))}
 </div>
 </div>
 ...
 <div className="space-y-8">
 <div>
 <h2 id="browser-extension" className="text-2xl font-semibold text-white mb-4">Browser Extension</h2>
 <p className="text-base text-slate-300 mb-6">
 ...
 <h4 className="font-medium text-white mb-2">Google Chrome</h4>
 ...
 <div className="bg-white/[0.05] border border-white/10 rounded-xl p-6">
 <h4 className="font-medium text-white mb-2">Mozilla Firefox</h4>
 <p className="text-base text-slate-300 mb-2">
 ...
 <h3 className="text-xl font-semibold text-white mb-3">What the Extension Does</h3>
 <div className="space-y-4 mb-8">
 <div>
 <h4 className="font-medium text-white mb-2">Pre-Signing Risk Assessment</h4>
 ...
 <div>
 <h4 className="font-medium text-white mb-2">Quick Allowance Overview</h4>
 <p className="text-base text-slate-300">
 ...
 <div>
 <h4 className="font-medium text-white mb-2">Non-Custodial &amp; Privacy-First</h4>
 <p className="text-base text-slate-300">
 ...
 <h3 className="text-xl font-semibold text-white mb-3">How to Install</h3>
 ...
 <div className="space-y-8">
 <div>
 <h2 id="troubleshooting" className="text-2xl font-semibold text-white mb-4">Support & Troubleshooting</h2>
 
 <h3 id="common-issues" className="text-xl font-semibold text-white mb-3">Common Issues and Solutions</h3>
 <div className="space-y-6 mb-8">
 <div>
 <h4 className="font-medium text-white mb-2">Why can&apos;t I see my allowances?</h4>
 <p className="text-base text-slate-300">This could indicate several scenarios. First, you may genuinely have no token approvals, which is actually a good security posture. Second, there might be a network connectivity issue preventing the scan from completing. Third, the blockchain indexer might be experiencing delays. Try switching networks, refreshing the page, or reconnecting your wallet. If the problem persists, contact support with your wallet address and network information.</p>
 </div>
 <div>
 <h4 className="font-medium text-white mb-2">Why did my transaction fail?</h4>
 <p className="text-base text-slate-300">Transaction failures are typically due to insufficient gas fees, network congestion, or nonce conflicts. Ensure you have enough ETH in your wallet to cover gas costs, and consider increasing the gas price for faster confirmation during network congestion. If the transaction fails due to a nonce issue, wait a few minutes before retrying. Some contracts may also require specific revocation methods or have additional security measures that prevent standard revocation.</p>
 </div>
 <div>
 <h4 className="font-medium text-white mb-2">Why is a known protocol flagged as risky?</h4>
 <p className="text-base text-slate-300">Our risk engine uses multiple heuristics that may flag legitimate protocols for various reasons. A protocol might be flagged if it has unlimited approvals, unverified source code, or appears on security watchlists due to past incidents. The risk score is designed to err on the side of caution, encouraging users to review each approval individually. You can still use the protocol while being aware of the associated risks, or consider revoking the approval if you no longer need it.</p>
 </div>
 <div>
 <h4 className="font-medium text-white mb-2">Why is my scan taking so long?</h4>
 <p className="text-base text-slate-300">Scan duration depends on several factors including the number of approvals, network congestion, and blockchain indexer performance. Wallets with extensive transaction history or many approvals may take several minutes to scan completely. The system processes scans in the background using a job queue, so you can continue using the application while the scan completes. If a scan appears stuck, try refreshing the page or reconnecting your wallet.</p>
 </div>
 </div>
 
 <h3 id="glossary" className="text-xl font-semibold text-white mb-3">Glossary of Terms</h3>
 <div className="space-y-4 mb-8">
 <div>
 <h4 className="font-medium text-white mb-2">Allowance</h4>
 <p className="text-base text-slate-300">A permission granted to a smart contract to spend a specific amount of your tokens. This is necessary for DeFi interactions but can become a security risk if left unchecked.</p>
 </div>
 <div>
 <h4 className="font-medium text-white mb-2">Revocation</h4>
 <p className="text-base text-slate-300">The process of setting an allowance to zero, completely removing a contract&apos;s ability to spend your tokens. This is accomplished through a blockchain transaction.</p>
 </div>
 <div>
 <h4 className="font-medium text-white mb-2">Gas</h4>
 <p className="text-base text-slate-300">The fee required to execute transactions on the Ethereum blockchain. Gas fees are paid to network validators and vary based on network congestion and transaction complexity.</p>
 </div>
 <div>
 <h4 className="font-medium text-white mb-2">Spender</h4>
 <p className="text-base text-slate-300">The smart contract address that has been granted permission to spend your tokens. This is typically a DEX router, NFT marketplace, or other DeFi protocol.</p>
 </div>
 <div>
 <h4 className="font-medium text-white mb-2">dApp</h4>
 <p className="text-base text-slate-300">Decentralized application - a blockchain-based application that operates without central authority, typically requiring token approvals for functionality.</p>
 </div>
 <div>
 <h4 className="font-medium text-white mb-2">Non-Custodial</h4>
 <p className="text-base text-slate-300">A security model where users hold their own keys and sign their own transactions; no third party can move funds on their behalf.</p>
 </div>
 </div>
 
 <h3 id="getting-help" className="text-xl font-semibold text-white mb-3">Getting Help</h3>
 <div className="space-y-4">
 <div>
 <h4 className="font-medium text-white mb-2">Technical Support</h4>
 <p className="text-base text-slate-300">For technical issues, feature requests, or general questions, contact our support team at support@allowanceguard.com. We typically respond within 24 hours and can help with wallet connection issues, transaction problems, or platform-specific questions.</p>
 </div>
 <div>
 <h4 className="font-medium text-white mb-2">Bug Reports</h4>
 <p className="text-base text-slate-300">If you encounter a bug or unexpected behavior, please report it on our GitHub repository with detailed information including your browser, wallet type, network, and steps to reproduce the issue. This helps us quickly identify and fix problems.</p>
 </div>
 <div>
 <h4 className="font-medium text-white mb-2">Community Updates</h4>
 <p className="text-base text-slate-300">Follow us on X for platform updates, security alerts, and community discussions. We regularly share security tips, new feature announcements, and important updates about the Web3 security landscape.</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <div key={index} className="border border-white/10 rounded-md p-4 bg-white/[0.03]">
 <h4 className="font-medium text-white mb-2">Q: {item.question}</h4>
 <p className="text-sm text-slate-300">A: {item.answer}</p>
 </div>
 ))}
 </div>
 </div>
