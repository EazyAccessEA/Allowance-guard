  ...
  return (
    <div className="min-h-screen">
      ...
      <Section className="py-32">
        <Container>
          <div className="max-w-4xl mx-auto">
            <h2 className="mobbin-heading-1 text-text-primary mb-12 mobbin-fade-in">Using the Dashboard</h2>
      ...
      <Section className="py-32">
        <Container>
          <div className="max-w-4xl mx-auto">
            <h2 className="mobbin-heading-1 text-text-primary mb-12 mobbin-fade-in">Advanced Security Questions</h2>
