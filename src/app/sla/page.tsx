...
export default function SLAPage() {
 ...
 <div className="border-l-4 border-crimson-paper/40 pl-6 bg-paper-sub/20 p-4 rounded-r-lg">
 <h3 className="text-lg font-medium mb-1 text-crimson-paper">Critical (P0)</h3>
 <p className="text-crimson-paper text-sm">
 ...
 <div className="border-l-4 border-ink-blue/30 pl-6 bg-paper-sub/20 p-4 rounded-r-lg">
 <h3 className="text-lg font-medium mb-1 text-ink-blue">Medium (P2)</h3>
 <p className="text-ink-blue text-sm">
