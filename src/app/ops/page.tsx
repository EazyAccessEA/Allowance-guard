  ...
  return (
    <main className="mx-auto max-w-4xl px-6 py-10">
      ...
      <div className="mt-3 flex gap-2">
        ...
        <button onClick={()=>{ localStorage.setItem('ops_token', token); load() }} className="rounded border border-black bg-black text-ink px-3 py-1 text-sm hover:bg-gray-800">Load</button>
      </div>
