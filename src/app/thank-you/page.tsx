...
export default function ThankYouPage() {
 ...
 <div className="bg-paper-sub border border-semantic-success-600/40 p-6 mb-8">
 <p className="text-lg font-semibold text-semantic-success-700">
 Payment Confirmed: {amountDisplay}
 </p>
 <p className="text-sm text-semantic-success-700 mt-1">
