...
const THIRD_PARTIES = [
  ...
  { name: 'Upstash', purpose: 'Redis caching and rate limiting. Encrypted, serverless.' },
  { name: 'Resend / Postmark', purpose: 'Email delivery. Receives recipient email and message content only.' },
