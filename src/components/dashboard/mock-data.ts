...
> = {
 ...
 icon: '✓',
 className:
 'bg-semantic-success-50 text-semantic-success-700 border-semantic-success-200 ',
 },
 medium: {
 label: 'Medium',
 icon: '⚠',
 className:
 'bg-semantic-warning-50 text-semantic-warning-700 border-semantic-warning-200 ',
 },
 high: {
 label: 'High',
 icon: '▲',
 className:
 'bg-semantic-error-50 text-semantic-error-700 border-semantic-error-200 ',
 },
 critical: {
 label: 'Critical',
 icon: '✕',
 className:
 'bg-semantic-error-100 text-semantic-error-800 border-semantic-error-300 ',
 },
}
