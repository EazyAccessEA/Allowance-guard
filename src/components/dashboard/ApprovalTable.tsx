                ...
                >
                  ...
                  <td className="py-3 px-3 text-right">
                    <button
                      ...
                      className="px-3 py-1 rounded-md text-xs font-medium text-semantic-error-600 dark:text-semantic-error-400 border border-semantic-error-200 dark:border-semantic-error-800 hover:bg-semantic-error-50 dark:hover:bg-semantic-error-900/30 transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-semantic-error-500 focus-visible:ring-offset-2"
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  onClick={() => onRevoke(approval.id)}
                  className="px-3 py-1.5 rounded-md text-xs font-medium text-semantic-error-600 dark:text-semantic-error-400 border border-semantic-error-200 dark:border-semantic-error-800 hover:bg-semantic-error-50 dark:hover:bg-semantic-error-900/30 transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-semantic-error-500"
                  aria-label={`Revoke ${approval.tokenSymbol} approval`}
                >
                  Revoke
                </button>
