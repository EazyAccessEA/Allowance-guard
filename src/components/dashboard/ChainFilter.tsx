          ...
          <button
            ...
            className={cn(
              ...
              isActive
                ...
                : 'bg-paper-sub text-secondary-600 dark:text-ink-soft border-ink-rule hover:border-primary-300 dark:hover:border-primary-600 hover:text-amber-deep dark:hover:text-amber-deep'
            )}
          >
            {dotColor && !isActive && (
              <span
