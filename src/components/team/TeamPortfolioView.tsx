...
export default function TeamPortfolioView({ teamId }: TeamPortfolioViewProps) {
 ...
 w.risk_score >= 70 ? 'text-crimson-paper' :
 w.risk_score >= 40 ? 'text-amber-deep' : 'text-semantic-success-700'
 }`} />
 ...
 className="text-xs text-amber-deep hover:underline flex items-center gap-1"
 >
