...
const methodColors: Record<string, string> = {
 GET: 'bg-paper-sub text-semantic-success-700 border-semantic-success-600/40',
 POST: 'bg-paper-sub text-ink-blue border-ink-blue/30/30',
 PUT: 'bg-paper-sub text-amber-deep border-amber-500/30',
 DELETE: 'bg-paper-sub text-crimson-paper border-crimson-paper/40/30',
}
...
export function ApiEndpoint({
 ...
 {p.required ? (
 <span className="text-xs text-crimson-paper">required</span>
 ) : (
