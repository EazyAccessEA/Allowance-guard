...
export default function RuleBuilder() {
 ...
 size="sm"
 >
 <Trash2 className="w-3 h-3 text-crimson-paper" />
 </Button>
 )}
 </div>
 )
 ...
 newAction === value
 ? 'border-amber-deep bg-paper-sub ring-1 ring-amber-deep'
 : 'border-ink-rule hover:border-amber-deep/50'
 }`}
 >
 <div className="flex items-center gap-2 mb-1">
 <Icon className="w-4 h-4" />
 <span className="text-sm font-medium">{label}</span>
 {newAction === value && <Check className="w-3 h-3 text-amber-deep ml-auto" />}
 </div>
 ...
 >
 <div className={`w-2 h-2 rounded-full ${rule.enabled ? 'bg-paper-sub' : 'bg-paper-deep'}`} />
 ...
 variant="ghost"
 size="sm"
 className="text-crimson-paper hover:text-crimson-paper"
 >
