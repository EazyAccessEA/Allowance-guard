...
export default function MonitoringDashboard({ wallet }: MonitoringDashboardProps) {
 ...
 switch (type) {
 case 'new_approval': return <Plus className="w-4 h-4 text-ink-blue" />
 case 'approval_changed': return <ArrowUpRight className="w-4 h-4 text-amber-deep" />
 case 'approval_removed': return <Minus className="w-4 h-4 text-semantic-success-700" />
 case 'risk_increased': return <AlertTriangle className="w-4 h-4 text-crimson-paper" />
 }
 }
 ...
 <Eye className="w-5 h-5 text-amber-deep" />
 Monitoring Status
 </CardTitle>
 ...
 <div className="w-4 h-4 bg-paper-deep rounded-full mt-0.5"></div>
 <div className="flex-1 space-y-2">
 <div className="h-4 bg-paper-deep rounded w-1/3"></div>
 <div className="h-3 bg-paper-deep rounded w-2/3"></div>
 <div className="h-3 bg-paper-deep rounded w-1/4"></div>
 </div>
 </div>
 ))}
 </div>
 ...
 : 'border-amber-deep/40 bg-paper-sub'
 }`}
 >
