 ...
 * Hand-crafted to match AllowanceGuard's Midnight Amber brand language.
...
export function AnalyzeIcon({ className, size = 80 }: IconProps) {
  return (
    ...
    >
      ...
      />
      {/* Glass inner fill */}
      <circle cx="36" cy="36" r="18" fill="#F59E0B" opacity="0.06" />
      {/* Handle */}
      <line
        x1="52"
        y1="52"
      ...
      <rect x="40" y="28" width="5" height="22" rx="1" fill="#38BDF8" opacity="0.7" />
      {/* Alert dot */}
      <circle cx="47" cy="25" r="3" fill="#FBBF24" opacity="0.9">
...
export function RevokeIcon({ className, size = 80 }: IconProps) {
  return (
    ...
    >
      ...
      />
      {/* Break marks */}
      <line x1="35" y1="36" x2="38" y2="32" stroke="#FBBF24" strokeWidth="1.5" strokeLinecap="round" opacity="0.6" />
      <line x1="42" y1="48" x2="45" y2="44" stroke="#FBBF24" strokeWidth="1.5" strokeLinecap="round" opacity="0.6" />
...
export function LockShieldIcon({ className, size = 48 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} aria-hidden="true">
      <circle cx="24" cy="24" r="20" fill="#F59E0B" opacity="0.08" />
      <rect x="16" y="22" width="16" height="12" rx="2" stroke="#F59E0B" strokeWidth="1.5" fill="none" />
      <path d="M20 22V18C20 15.8 21.8 14 24 14C26.2 14 28 15.8 28 18V22" stroke="#F59E0B" strokeWidth="1.5" strokeLinecap="round" fill="none" />
...
export function DashboardIcon({ className, size = 48 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} aria-hidden="true">
      <circle cx="24" cy="24" r="20" fill="#F59E0B" opacity="0.08" />
      <rect x="12" y="14" width="24" height="20" rx="3" stroke="#F59E0B" strokeWidth="1.5" fill="none" />
      <line x1="12" y1="20" x2="36" y2="20" stroke="#F59E0B" strokeWidth="1.5" opacity="0.5" />
      <rect x="15" y="23" width="8" height="4" rx="1" fill="#38BDF8" opacity="0.6" />
      <rect x="15" y="29" width="5" height="2" rx="0.5" fill="#F59E0B" opacity="0.4" />
      <rect x="25" y="23" width="8" height="8" rx="1" stroke="#F59E0B" strokeWidth="1" fill="none" opacity="0.4" />
    </svg>
  )
}
...
export function BrainShieldIcon({ className, size = 48 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} aria-hidden="true">
      <circle cx="24" cy="24" r="20" fill="#F59E0B" opacity="0.08" />
      <circle cx="24" cy="22" r="10" stroke="#F59E0B" strokeWidth="1.5" fill="none" />
      {/* Neural network dots */}
      ...
      {/* Connections */}
      <line x1="24" y1="18" x2="20" y2="24" stroke="#F59E0B" strokeWidth="0.75" opacity="0.5" />
      <line x1="24" y1="18" x2="28" y2="24" stroke="#F59E0B" strokeWidth="0.75" opacity="0.5" />
      <line x1="20" y1="24" x2="24" y2="28" stroke="#F59E0B" strokeWidth="0.75" opacity="0.5" />
      <line x1="28" y1="24" x2="24" y2="28" stroke="#F59E0B" strokeWidth="0.75" opacity="0.5" />
      {/* Antenna / alert */}
      <path d="M24 12V8" stroke="#F59E0B" strokeWidth="1.5" strokeLinecap="round" />
      <path d="M19 36L24 32L29 36" stroke="#F59E0B" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    </svg>
  )
}
...
export function BatchGasIcon({ className, size = 48 }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" fill="none" className={className} aria-hidden="true">
      <circle cx="24" cy="24" r="20" fill="#38BDF8" opacity="0.06" />
      {/* Stacked layers — batch */}
      <rect x="14" y="20" width="20" height="12" rx="2" stroke="#F59E0B" strokeWidth="1.5" fill="none" />
      <rect x="17" y="17" width="20" height="12" rx="2" stroke="#F59E0B" strokeWidth="1" fill="none" opacity="0.5" />
      <rect x="20" y="14" width="20" height="12" rx="2" stroke="#F59E0B" strokeWidth="0.75" fill="none" opacity="0.3" />
      {/* Lightning bolt — gas savings */}
      <path d="M26 22L22 27H26L24 32" stroke="#38BDF8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" fill="none" />
    </svg>
  )
}
