...
export default function TokenResultCard(p: Props) {
  return (
    <div className="bg-paper-sub rounded-xl border border-border-default p-6 hover:border-primary-accent/30 hover:shadow-lg transition-all duration-200 group">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-start justify-between gap-4 mb-3">
            ...
            {/* Action Button */}
            <button className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 px-4 py-2 bg-primary-accent text-ink rounded-lg text-sm font-medium hover:bg-primary-accent/90">
              View Details
            </button>
          </div>
