...
export default function AuditReport({ teamId, wallets }: AuditReportProps) {
 ...
 <FileText className="w-5 h-5 text-amber-deep" />
 ...
 : 'border-ink-rule hover:border-amber-deep/40'
 }`}
 >
 ...
 format === 'csv'
 ? 'border-amber-deep bg-paper-sub text-amber-deep'
 : 'border-ink-rule text-ink-muted hover:border-amber-deep/40'
 }`}
 >
 CSV
 </button>
