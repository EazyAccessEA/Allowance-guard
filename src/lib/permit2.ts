...
export const KNOWN_PERMIT2_SPENDERS: KnownSpender[] = [
  {
    ...
    addresses: {
      ...
      534352: '0x3fC91A3afd70395Cd496C647d5a6CC9D4B2b7FAD', // Scroll
      42220: '0x3fC91A3afd70395Cd496C647d5a6CC9D4B2b7FAD', // Celo
    },
    risk: 'low',
  },
  {
    ...
    addresses: {
      ...
      59144: '0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45', // Linea
      534352: '0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45', // Scroll
      42220: '0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45', // Celo
    },
    risk: 'low',
  },
  {
    ...
    addresses: {
      ...
      534352: '0x1111111254EEB25477B68fb85Ed929f73A960582', // Scroll
    },
    risk: 'low',
  },
  {
    ...
    addresses: {
      ...
      5000: '0x111111125421cA6dc452d289314280a0f8842A65', // Mantle
  ...
  },
  {
    ...
    addresses: {
      ...
      100: '0x6A000F20005980200259B80c5102003040001068', // Gnosis
      59144: '0x6A000F20005980200259B80c5102003040001068', // Linea
    },
    risk: 'low',
  },
  {
    ...
    addresses: {
      ...
      100: '0x9008D19f58AAbD9eD0D60971565AA8510560ab41', // Gnosis (CoW's home chain)
    },
    risk: 'low',
  },
]
