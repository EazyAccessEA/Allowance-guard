...
<body>
  <div class="container">
    ...
    <div class="header">
      <img src="https://www.allowanceguard.com/images/branding/ag-logo.png" alt="Allowance Guard" style="width: 80px; height: 80px; margin: 0 auto 20px auto; display: block;">
